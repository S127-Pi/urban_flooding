...
class PrecipitationNL(object):
	...
	def __init__(self, queue_size=36):
		...
		if is_dslab:
			self.dir = '/local/s2656566/regen_project/src/helpers/neerslag/'
		else:
			self.dir = dire
	...
	# @helper.timing
	# n = numbers of hours to collect rain information
...
if __name__ == '__main__':
	...
	d = pnl.get_precipation_data_past_hours_list(2021, 1, 20, 12, 5, 52.1613, 4.49063, 5)
	print(d)
